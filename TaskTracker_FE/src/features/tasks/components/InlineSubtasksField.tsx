...
/** Shown right under the team picker once a team's actually been chosen (see CreateTaskForm and
 *  CreateSubtaskForm's implementation-task case) — lets whoever's assigning work to that team break it
 *  straight into individual subtasks in the same step, instead of a separate trip to "Add subtask" per
 *  member afterward. */
